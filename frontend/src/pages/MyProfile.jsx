...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit ? 
        <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4' type="text" value={userData.name} onChange={e => userData(prev => ({...prev, name:e.target.value}))}/>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? 
            <input className='bg-gray-100 max-w-52' type="text" value={userData.phone} onChange={e => userData(prev => ({...prev, phone:e.target.value}))}/>
